...
namespace AndreGaragePayment.Controllers
{
    ...
    public class PaymentsController : ControllerBase
    {
        ...
        public PaymentsController(AndreGaragePaymentContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Payment>>> GetPayment()
        {
          if (_context.Payment == null)
          {
            ...
            return await _context.Payment.Include(p => p.Card).Include(p => p.Boleto).Include(p => p.Pix).ToListAsync();
        }
        ...
        public async Task<ActionResult<Payment>> GetPayment(int id)
        {
          if (_context.Payment == null)
          {
            ...
            var payment = await _context.Payment.Include(p => p.Card).Include(p => p.Boleto).Include(p => p.Pix).FirstOrDefaultAsync(p => p.Id == id);
        ...
        public async Task<ActionResult<Payment>> PostPayment(PaymentDTO dto)
        {
          ...
          if (_context.Payment == null)
          {
              return Problem("Entity set 'AndreGaragePaymentContext.Payment'  is null.");
          }
