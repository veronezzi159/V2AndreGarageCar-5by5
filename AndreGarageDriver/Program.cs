...
builder.Services.AddDbContext<AndreGarageDriverContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("AndreGarageDriverContext") ?? throw new InvalidOperationException("Connection string 'AndreGarageDriverContext' not found.")));
